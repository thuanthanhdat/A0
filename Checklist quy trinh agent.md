...
OWNER=Codex
ACTION=Ủy quyền chính thức: Codex tiến hành Merge PR #<PR_NUMBER> vào main; sau đó thực hiện verify main SHA, target file status và báo cáo kết quả.
NEXT=Gửi A Review
